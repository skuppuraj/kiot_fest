...
/**
 * Reusable EventCard Component - Branch 08: Prop-Drilling Problem
 * Accepts event data, cart membership state, and cart handlers via PROPS drilled from parent.
 */
      ...
      <div className="mt-6 pt-4 border-t border-slate-800/80 flex justify-between items-center">
        ...
        <div className="flex items-center gap-2">
          ...
          {isSoldOut ? (
            ...
            <button 
              onClick={() => onRemoveFromCart ? onRemoveFromCart(id) : null}
            ...
            <button 
              onClick={() => {
                ...
                else if (onQuickRegister) onQuickRegister(data);
                else if (onRegister) onRegister(data);
              }}
